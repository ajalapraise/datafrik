...
const Footer = () => {
    return (
        <div className='flex w-[80%] flex-col  h-[405px] p-10 justify-center items-center'>
            <div className='flex justify-evenly items-center w-[65%] h-full'>
                <div className='flex flex-col w-[100px] h-full justify-evenly items-center'>
                ...
                <div className='flex flex-col w-[100px] h-full justify-start items-center'>
            ...
            <h1 className='text-lg font-bold mt-10'>&copy; 2024</h1>
        </div>
